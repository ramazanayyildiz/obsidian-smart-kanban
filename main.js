...
const { VIEW_TYPE_SMART_KANBAN, DEFAULT_SETTINGS, THEME_PRESETS } = require("./constants");
const {
  normalizeDateInput,
  getDueInfo,
  parseTaskLine,
...
const { SmartKanbanView } = require("./view")({ ItemView, TFile, Notice });
const { SmartKanbanSettingTab } = require("./settings-tab")({ PluginSettingTab, Setting, Notice });
