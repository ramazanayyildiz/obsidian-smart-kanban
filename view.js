const { VIEW_TYPE_SMART_KANBAN } = require("./constants");
const { normalizeDateInput, splitCsv } = require("./core-fallback");

module.exports = function createView({ ItemView, TFile, Notice }) {
